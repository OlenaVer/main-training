...
document.write(`<ol>`);
for (let a = 0; a<10; a++) {
    document.write(`<div>Lorem ipsum dolor.${a}</div>`);
}
document.write(`</ol>`);
...
document.write(`<div class="h">`);
// for (let f=0; f<products.length; f++){
    for (let product of products){
    document.write(`<div class="poduct-card"><h3 class="product-title">${product.title}. Prise - ${product.price}</h3>
